...
public class ClusterwideSingletonServiceActivator implements ServiceActivator {
    ...
    public void activate(ServiceActivatorContext context) {
        ...
        ClusterwideSingletonService service = new ClusterwideSingletonService();
        SingletonService<ClusterWideSingleton> singleton = new SingletonService<ClusterWideSingleton>(service, ClusterwideSingletonService.SINGLETON_SERVICE_NAME);
